                    ...
                    <div class="rulespolicy-parent">
                        ...
                        <!-- --------------------  -------------------- -->
                            <div class="container">
                                ...
                                <p class="rulespolicy-sm-txt">A. The invitee's should be one that has not yet been registered and verified with Binance Example as at the time the inviter makes hes first deposit.
                                <br>
                                B. After signing up on Binance Example, the invitee should make deposits to get x6 their deposit.</p>
                                ...
                                <p class="rulespolicy-sm-txt">A new user can only be bound by the inviter once, and one device and account can only participate once. Should there be any suspicious invitations, Binance reserves the right to withhold any rewards that may apply. There are a variety of uncertain factors on the internet, so please understand and accept that Binance Example holds the right to take measures such as eliminating irregularities or adjusting, suspending or canceling this event via different means due to unforeseen occurrences like force majeure, network issues, communication line failure, massive computer paralysis or large-scale cheating during this activity - without being held liable for any consequent losses incurred by you.</p>
